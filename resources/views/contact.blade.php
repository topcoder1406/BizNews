...
@section('main-content')
    ...
    <div class="bg-white border border-top-0 p-4 mb-3">
        <div class="mb-4">
            ...
            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci ea, excepturi ipsum iure laborum magnam nihil officiis saepe sit soluta temporibus voluptates. Dolore doloribus fugiat omnis quis similique sit ut!</p>
            <div class="mb-3">
